...
const steps = ['Basics', 'Contract Inputs', 'Event Listeners', 'Final Review'];
        ...
        {allStepsCompleted() ? (
          ...
          <React.Fragment>
            <Typography sx={{ mt: 2, mb: 1, py: 1 }}>
              {activeStep === 0 ? <Step1  setTheInput={setTheInput}/> : (activeStep === 1 ? <Step2 contractFunctions={props.contractFunctions} /> : (activeStep === 2 ? <Step3 /> : <Step4/>))}
            </Typography>
            <Box sx={{ display: 'flex', flexDirection: 'row', pt: 2 }}>
              <Button
                color="inherit"
